...
\label{chapter:background}
  ...
  \section{Review of Current Practices}
    ...
    \subsection{Selecting Goals}
      ...
      \todo{
        \item There are a number of choices over what to learn that do not seem to make very much sense: Why make everyone study Shakespeare? What about specialist subjects that are not optional? Why is critical thinking not part of the core curriculum? Why are widely useful software engineering skills left until third year, yet group project work is done predominantely in the first and second years?
