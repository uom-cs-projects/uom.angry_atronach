  ...
  \section{Review of Current Practices}
    ...
    \subsection{Testing}
      ...
      \subsubsection{Diagnostic and Certification Testing}
        ...
        It would be beneficial for students if certification testing could be done as close to on-demand as possible.
      ...
      \subsubsection{Aggregated Scoring}
        ...
        Aggregate scoring may be useful as a measure of general progress, but it would be wise not to discard precise information on what a student understands. Aggregate scoring should only be used in summaries.

        \todo{
          \item Rewrite
          \item Mention that this is noted in TGAT.\cite[pa.~25]{tgat}
        }
      ...
      \subsubsection{Subjective Grading}
        \todo{
          ...
          \item Some tests rely on the discrimination of the tester: This is certainly problematic. Experiments show that there is significant gender bias. Tests need to be anonymous.
        }
